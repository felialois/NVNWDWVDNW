...
public class ExampleStreaming : MonoBehaviour
{
    ...
    private string _username_STT = "04bf7249-83fc-4266-909c-6de395006594";
    private string _password_STT = "KYcon6kfYCaj";
    ...
    private string _iamApikey = "ZjqiBybQQ0pbMEvsLgcKO15O14kCWaoUxALQTaqHUgKN";

    private string _iamUrl = "https://gateway-syd.watsonplatform.net/text-to-speech/api";
    ...
    void Start()
    {
        ...
        //    Credentials credentials_TTS = new Credentials(_username_TTS, _password_TTS, _url_STT);
        Credentials credentials_TTS = new Credentials(tokenOptions, _url_TTS);
